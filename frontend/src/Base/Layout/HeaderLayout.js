  ...
  return (
    <div className="header">
      <div className="header-buttons-container">
        ...
        { authUser.role === Role.USER || authUser.role === Role.MODERATOR || authUser.role === Role.ADMIN && <NavLink to={"/board-book"} className="home-btn">{strings.pages.boardBook.title}</NavLink> }
      </div>
